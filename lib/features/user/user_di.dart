...
void initUserDI() {
  ...
  getIt.registerLazySingleton<SaveUserDetailUseCase>(
    () => SaveUserDetailUseCase(getIt<UserRepository>()),
  );
  getIt.registerLazySingleton<GetSavedUserDetailUseCase>(
    () => GetSavedUserDetailUseCase(getIt<UserRepository>()),
  );
  ...
  getIt.registerFactory<UserBloc>(
    () => UserBloc(
      getIt<FetchMeUseCase>(),
      getIt<GetSavedUserDetailUseCase>(),
      getIt<SaveUserDetailUseCase>(),
    ),
  );
}
